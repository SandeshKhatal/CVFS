...
void man(char *name)
{
    ...
    {
        printf("Description : Used to closea all opened file\n");
...
void DisplayHelp()
{
    ...
    printf("exit : To Teminate the file system\n");
    printf("stat : To Display informataion of file using name\n");
    printf("fstat : To Display informataion of file using file descriptor\n");
